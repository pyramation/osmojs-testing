...
export declare const Cosmos_evidenceEvidence_InterfaceDecoder: (input: _m0.Reader | Uint8Array) => Any;
export declare const Cosmos_evidenceEvidence_FromAmino: (content: AnyAmino) => Any;
export declare const Cosmos_evidenceEvidence_ToAmino: (content: Any) => AnyAmino;
