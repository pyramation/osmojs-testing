...
export declare const createRPCQueryClient: ({ rpcEndpoint }: {
    ...
    osmosis: {
        ...
        swaprouter: {
            v1beta1: {
                params(request?: import("./swaprouter/v1beta1/query").ParamsRequest): Promise<import("./swaprouter/v1beta1/query").ParamsResponse>;
                estimateSwapExactAmountIn(request: import("./swaprouter/v1beta1/query").EstimateSwapExactAmountInRequest): Promise<import("./swaprouter/v1beta1/query").EstimateSwapExactAmountInResponse>;
                estimateSwapExactAmountOut(request: import("./swaprouter/v1beta1/query").EstimateSwapExactAmountOutRequest): Promise<import("./swaprouter/v1beta1/query").EstimateSwapExactAmountOutResponse>;
                numPools(request?: import("./swaprouter/v1beta1/query").NumPoolsRequest): Promise<import("./swaprouter/v1beta1/query").NumPoolsResponse>;
            };
        };
        tokenfactory: {
            v1beta1: {
